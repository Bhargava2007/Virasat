<template>
  <q-page class="placeholder-page">
    <div class="placeholder-page__content">
      <div class="placeholder-page__icon-wrapper">
        <q-icon name="auto_stories" size="48px" color="primary" />
      </div>
      <h1 class="placeholder-page__title">Heritage Passport</h1>
      <p class="placeholder-page__subtitle"
        >Your personal journey through India's heritage</p
      >
...
.placeholder-page__icon-wrapper {
  width: 88px;
  height: 88px;
  border-radius: 24px;
